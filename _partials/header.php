<!-- Desktop Navbar (1400px and above) -->
<nav class="navbar navbar-expand-lg custom-navbar w-100 py-3 d-none desktop-navbar">
    <div class="container-fluid d-flex align-items-center justify-content-between">
        ...
        <!-- Center: Logo -->
        <div class="navbar-logo" style="flex: 0 0 auto; margin: 0 auto;">
            <img src="assets/images/logo.png" alt="GR Yachts Dubai" height="160">
        </div>
        <!-- Right: Contact and Selectors -->
        <div class="d-flex align-items-center justify-content-end flex-grow-1 flex-shrink-1 flex-basis-0 gap-3 pe-5" style="flex: 1 1 0%;">
            <div class="d-flex align-items-center gap-2" style="margin-right: 2rem;">
                <i class="fab fa-whatsapp text-light" style="font-size: 1.2rem;"></i>
            ...
            <div class="translate-widget">
                ...
                <div class="translate-menu" id="translateMenu">
                    ...
                    <div class="translate-option" onclick="changeLanguage('pt', 'PT', '🇵🇹')">
                        <span class="flag">🇵🇹</span>
                        <span class="language-name">Português</span>
                    </div>
                    <div class="translate-option" onclick="changeLanguage('ja', 'JP', '🇯🇵')">
                        <span class="flag">🇯🇵</span>
                        <span class="language-name">日本語</span>
                    </div>
                    <div class="translate-option" onclick="changeLanguage('ko', 'KR', '🇰🇷')">
                        <span class="flag">🇰🇷</span>
                        <span class="language-name">한국어</span>
                    </div>
                    <div class="translate-option" onclick="changeLanguage('th', 'TH', '🇹🇭')">
                        <span class="flag">🇹🇭</span>
                        <span class="language-name">ไทย</span>
                    </div>
                    <div class="translate-option" onclick="changeLanguage('tr', 'TR', '🇹🇷')">
                        <span class="flag">🇹🇷</span>
...
<!-- Mobile Navbar (below 1400px) -->
<nav class="navbar mobile-navbar w-100 py-2 mobile-navbar-show">
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="mobileNavMenu">
            <ul class="navbar-nav w-100 mobile-nav-menu">
                <li class="nav-item">
                    <a class="nav-link active mobile-nav-link" href="/">
            ...
            <div class="mobile-selectors mt-3 pt-3 border-top">
                <div class="row">
                    ...
                    <div class="col-6">
                        <label class="text-white-50 small mb-2">Language</label>
                        <div class="mobile-translate-widget">
                            <div class="mobile-translate-dropdown translate-dropdown" onclick="toggleMobileTranslateMenu()">
                                <i class="fas fa-language"></i>
                                <span class="current-language">EN</span>
                                <i class="fas fa-chevron-down"></i>
                            </div>
                            <div class="mobile-translate-menu translate-menu" id="mobileTranslateMenu">
                                <div class="translate-option active" onclick="changeLanguage('en', 'EN', '🇺🇸')">
                                    <span class="flag">🇺🇸</span>
                                    <span class="language-name">English</span>
                                </div>
            ...
            <div class="mobile-contact-info mt-3 pt-3 border-top">
                <div class="d-flex align-items-center justify-content-center gap-3">
                    ...
                    <div>
                        <div class="fw-bold">Call us now</div>
                        <div class="contact-number-large">+971 50 554 3873</div>
                    </div>
                </div>
            </div>
        </div>
